...
int getsquad(int id)
{
   for(int i=0;i<(int)squad.size();i++)if(squad[i]->id==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)vehicle.size();i++)if(vehicle[i]->id()==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)pool.size();i++)if(pool[i]->id==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)vehicletype.size();i++)if(vehicletype[i]->id()==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)vehicletype.size();i++)if(vehicletype[i]->idname()==idname)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)cliptype.size();i++)if(cliptype[i]->get_id()==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)cliptype.size();i++)if(cliptype[i]->get_idname()==idname)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)weapontype.size();i++)if(weapontype[i]->get_id()==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)weapontype.size();i++)if(weapontype[i]->get_idname()==idname)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)armortype.size();i++)if(armortype[i]->get_id()==id)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)armortype.size();i++)if(armortype[i]->get_idname()==idname)return i;
   return -1;
}
...
{
   for(int i=0;i<(int)loottype.size();i++)if(loottype[i]->get_id()==id)return i;
   return -1;
}
